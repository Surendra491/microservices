package com.sj.cards.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException argumentNotValidException
        ...
        List<ObjectError> validationErrosList = argumentNotValidException.getAllErrors();
    ...
    public ResponseEntity<ErrorResponseDto> handleResourceNotFoundException(ResourceNotFoundException notFoundException
